...
{
	HashMap<String, SquarePolygon> images;
	Curve quadCurve;
	MapEditor mapEditor;
	int index = 0;
	...
	public HashMap<String, SquarePolygon> getImages()
	{
		return images;
	}
...
//		images.put("curve", new Curve(mapEditor, "curveGround", new Point2D(0.0, 0.0), new Point2D(60.0, 60.0)));
