...
public abstract class AbstractMatchManager implements MatchManager {
    ...
    protected String matchTimerString;
    protected String turnTimerString;
	...
	return timer.matchTimerStringFormat();
    }

    @Override
    public String turnTimerLeft() {
	if (!timer.isTurnTimerStopped())
	    return timer.turnTimerStringFormat();
	else
	    return timer.attackTimerStringFormat();	
    }

    @Override
    public void setMatchTimerLeft(String s) {
	matchTimerString=s;
    }

    @Override
    public void setTurnTimerLeft(String s) {
	turnTimerString=s;
    }
	...
	return teamB.isLose() || teamA.isLose() || timer.isMatchTimerEnded();
    }
	...
	List<Character> charactersOutOfWorld = battlefield
		.getCharacatersOutOfWorld();
