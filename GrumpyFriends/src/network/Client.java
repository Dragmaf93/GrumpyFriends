...
//		}).start();
	...
	public InfoMatch requestInfoMatch(InfoMatch matchChoosed) throws IOException {
		outToServer.writeBytes(Message.OP_REQUEST_INFO_MATCH);
		return null;
	}
	
	public boolean chooseMatch(InfoMatch matchChoosed) throws IOException {
		outToServer.writeBytes(Message.OP_SELECT_MATCH+";"+matchChoosed.getId()+"\n");
	...
	public boolean createMatch(InfoMatch match) throws IOException {
		...
		outToServer.writeBytes(Message.OP_CREATE_MATCH+";"+matchJson+'\n');
